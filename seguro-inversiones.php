...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-4 animated slideInDown mb-4">Seguro - Inversiones</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                    <li class="breadcrumb-item"><a href="#">Página</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Inversiones</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div class="bg-light rounded p-3">
                        <div class="d-flex align-items-center bg-white rounded p-3">
                            <p class="mb-0">•	Mejor rendimiento anual</p>
                        </div>
                    </div>
                    <div class="bg-light rounded p-3">
                        <div class="d-flex align-items-center bg-white rounded p-3">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <select class="form-control" id="select" name="monto" required>
                                            <option value="">Monto mensual de inversión</option>
